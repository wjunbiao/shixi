    ...
    <el-container>
      <el-aside :width="asideWidth">
        <div style="height: 60px; line-height: 60px; font-size: 20px; display: flex; align-items: center; justify-content: center">
          ...
          <span class="logo-title" v-show="!isCollapse">教育实习 教师端</span>
        </div>
        <el-menu router :collapse="isCollapse" :collapse-transition="false" background-color="#001529"
          ...
          <el-sub-menu index="1">
            <template v-slot:title><el-icon><Platform /></el-icon><span>班级管理</span></template>
            <el-menu-item index="/tea1" @click="two='学生管理'">学生管理</el-menu-item>
            <el-menu-item index="/tea2" @click="two='主题活动'">主题活动</el-menu-item>
          </el-sub-menu>
          <el-sub-menu index="2" :disabled="islimit==0">
            <template v-slot:title><el-icon><Avatar /></el-icon><span>实习管理</span></template>
            <el-menu-item index="/tea3" @click="two='实习计划'">实习计划</el-menu-item>
            <el-menu-item index="/tea4" @click="two='实习单位'">实习单位</el-menu-item>
            <el-menu-item index="/tea5" @click="two='实习任务'">实习任务</el-menu-item>
            <el-menu-item index="/tea12" @click="two='实习作业'">实习作业</el-menu-item>
            <el-menu-item index="/tea13" @click="two='实习成绩'">实习成绩</el-menu-item>
          </el-sub-menu>
          <el-sub-menu index="3">
            <template v-slot:title><el-icon><HomeFilled /></el-icon><span>教学管理</span></template>
            <el-menu-item index="/tea6" @click="two='听课记录'">听课记录</el-menu-item>
            <el-menu-item index="/tea7" @click="two='授课记录'">授课记录</el-menu-item>
            <el-menu-item index="/tea8" @click="two='教研活动'">教研活动</el-menu-item>
            <el-menu-item index="/tea9" @click="two='教案管理'">教案管理</el-menu-item>
            <el-menu-item index="/tea10" @click="two='教学反思'">教学反思</el-menu-item>
          </el-sub-menu>
           <el-sub-menu index="4">
            <template v-slot:title ><el-icon><Comment /></el-icon><span>通告管理</span></template>
            <el-menu-item index="/tea11" @click="two='通告管理'">通告管理</el-menu-item>
          </el-sub-menu>
        </el-menu>
      </el-aside>
...
onMounted(() => {
  axios({
    ...
    islimit.value = res.data[0].limit

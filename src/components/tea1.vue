<template>
  <div class="one">
    ...
    >
      ...
      <el-table-column prop="year" label="入学年份" width="130">
      </el-table-column>
      ...
      <el-table-column prop="age" label="出生年月日" width="130">
      </el-table-column>
...
function data() {
  axios({
    url: 'http://localhost:8082/users33?state=学生&teacher='+window.sessionStorage.getItem('username'),
    method: 'get'
  }).then(res => {
